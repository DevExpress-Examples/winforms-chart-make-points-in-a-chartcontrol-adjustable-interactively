...
'#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim seriesPoint1 As DevExpress.XtraCharts.SeriesPoint = New DevExpress.XtraCharts.SeriesPoint("a", New Object() {(CObj((1R)))})
            Dim seriesPoint2 As DevExpress.XtraCharts.SeriesPoint = New DevExpress.XtraCharts.SeriesPoint("b", New Object() {(CObj((2R)))})
            Dim seriesPoint3 As DevExpress.XtraCharts.SeriesPoint = New DevExpress.XtraCharts.SeriesPoint("c", New Object() {(CObj((2R)))})
            Dim seriesPoint4 As DevExpress.XtraCharts.SeriesPoint = New DevExpress.XtraCharts.SeriesPoint("d", New Object() {(CObj((1R)))})
            ...
            AddHandler Me.chartControl1.MouseDown, New System.Windows.Forms.MouseEventHandler(AddressOf Me.chartControl1_MouseDown)
            AddHandler Me.chartControl1.MouseUp, New System.Windows.Forms.MouseEventHandler(AddressOf Me.chartControl1_MouseUp)
            ' 
            ' Form1
            ' 
